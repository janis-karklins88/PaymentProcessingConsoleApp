...
## Stretch goals
- Add a new payment method, for example crypto payment or bank transfer - Implemented
- Add tax calculation using AppConfig - Implemented
- Save completed orders in memory - Implemented
